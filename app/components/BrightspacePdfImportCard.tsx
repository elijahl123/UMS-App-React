  ...
  return (
    <Card className="h-auto">
      ...
      <CardContent className="flex min-w-0 flex-col gap-4 px-4 pb-4 sm:px-6 sm:pb-6">
        ...
        {result && (
          <div className="flex flex-col gap-2 rounded-md border border-[color-mix(in_srgb,var(--course-emerald)_64%,var(--surface))] bg-[color-mix(in_srgb,var(--course-emerald)_34%,var(--surface))] p-3 text-sm text-[color-mix(in_srgb,var(--course-emerald)_68%,var(--secondary-accent))]">
